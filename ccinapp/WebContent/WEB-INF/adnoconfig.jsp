...
<table width="80%" border="1" align="center">
	...
	<br><br>
	<a href="reload" >Reload Config(${lastreloadConfigTime})</a>
	<br><br>
	<tr align="center">
		<th>Operator Name</th>
	...
	<c:forEach var="vwadnetworkOperatorConfig" items="${list}" varStatus="outerloop">
			...
			<tr bgcolor="" align="center">
					...
					<td>${mapAdnetworkOpConfig.get(vwadnetworkOperatorConfig.operatorId)
					.get(vwadnetworkOperatorConfig.adNetworkId).atomicActSkipNumber}</td>					
				  <td>
				   <select name="skipno" >	
