...
<!-- Export excel file -->
<link
	href="${pageContext.request.contextPath}/resources/css/tableexport.css"
	rel="stylesheet">
...
<script type="text/javascript">
   ...
   // var opid = $(this).val();
    $.ajax({
        type: 'GET',
        url: "http://<%=request.getLocalAddr()%>
	/ccinapp/cnt/inapp/productdetail?opid="
							+ opid,
		...
		<table border="1" class="mtable" align="center">
			...
			<tr>
				...
				<td>
					<p>
						Advertiser
						<form:select class="formselect" name="advertiserid"
							id="advertiserid" path="advertiserid">
				...
				<td>
						...
						Action Type :
						<form:select class="formselect" name="actionType"
							id="actionType" path="actionType">
							<form:option value="none" label="Select Action" />
			...
			<tr>
				<td><label for="fromTime">From Time :</label>&nbsp; <form:input
						type="text" path="fromTime" name="fromTime" id="fromTime"
						class="text ui-widget-content ui-corner-all" /></td>
				<td><label for="toTime">To Time :</label>&nbsp; <form:input
						type="text" path="toTime" name="toTime" id="toTime"
						class="text ui-widget-content ui-corner-all" /></td>
			</tr>
			<tr>
				<td>
        			    ...
        			    <form:input type="text" path="cmpid" name="cmpid" id="cmpid" class="text ui-widget-content ui-corner-all"/>
				</td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" value="Find Report" /></td>
			</tr>
		</table>
		<br>
		<br>
