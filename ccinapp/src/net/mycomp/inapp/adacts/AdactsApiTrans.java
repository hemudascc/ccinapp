...
@Entity
@Table(name = "tb_adacts_api_trans")
public class AdactsApiTrans implements Serializable{
	...
	@Column(name = "adacts_campid")
	private Integer adactsCampid;
	...
	public AdactsApiTrans(){}
	
	public AdactsApiTrans(boolean status){
		this.status=status;
		this.success=false;
	...
	public Integer getAdactsCampid() {
		return adactsCampid;
	}

	public void setAdactsCampid(Integer adactsCampid) {
		this.adactsCampid = adactsCampid;
	}
