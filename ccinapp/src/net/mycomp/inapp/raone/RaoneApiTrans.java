...
@Entity
@Table(name = "tb_raone_api_trans")
public class RaoneApiTrans implements Serializable{
		...
		@Column(name = "raone_campid")
		private Integer raoneCampid;
		...
		public RaoneApiTrans(){}
		
		public RaoneApiTrans(boolean status){
			this.status=status;
			this.success=false;
		...
		public Integer getRaoneCampid() {
			return raoneCampid;
		}

		public void setRaoneCampid(Integer raoneCampid) {
			this.raoneCampid = raoneCampid;
		}
