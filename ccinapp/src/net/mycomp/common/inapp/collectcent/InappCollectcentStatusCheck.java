...
@Entity
@Table(name = "tb_inapp_collectcent_status_check")
public class InappCollectcentStatusCheck implements Serializable{
	...
	public InappCollectcentStatusCheck(){}
	
	public InappCollectcentStatusCheck(boolean status){
		this.status=status;
