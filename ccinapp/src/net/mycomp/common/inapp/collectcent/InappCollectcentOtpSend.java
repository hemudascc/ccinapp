...
@Entity
@Table(name = "tb_inapp_collectcent_otp_send")
public class InappCollectcentOtpSend implements Serializable{
    ...
    public InappCollectcentOtpSend(){}
	
	public InappCollectcentOtpSend(boolean status){
		this.status=status;
		this.sendOtp=false;
		this.createTime=new Timestamp(System.currentTimeMillis());
		//this.id=One97InappConstant.otpSendIdAtomicInteger.incrementAndGet();
	}
