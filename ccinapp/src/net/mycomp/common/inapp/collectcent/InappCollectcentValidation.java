...
@Entity
@Table(name = "tb_inapp_collectcent_otp_validation")
public class InappCollectcentValidation implements Serializable{
...
public InappCollectcentValidation(){}
	
	public InappCollectcentValidation(boolean status){
		this.status=status;
