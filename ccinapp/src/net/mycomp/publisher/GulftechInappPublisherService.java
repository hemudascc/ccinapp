...
@Service("gulftechInappPublisherService")
public class GulftechInappPublisherService implements IInappPublisherService{

	 private static final Logger logger = Logger
				.getLogger(GlobocomInappPublisherService.class.getName());
