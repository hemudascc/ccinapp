...
@Service("maclatoInappPublisherService")
public class MaclatoInappPublisherService implements IInappPublisherService{

	 private static final Logger logger = Logger
				.getLogger(MaclatoInappPublisherService.class.getName());
