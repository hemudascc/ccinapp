...
@Service("conversionMobiPublisherService")
public class ConversionMobiPublisherService implements IInappPublisherService{

	 private static final Logger logger = Logger
				.getLogger(ConversionMobiPublisherService.class.getName());
