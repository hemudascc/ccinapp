...
@Service("smileDigitalInappPublisherService")
public class SmileDigitalInappPublisherService implements IInappPublisherService{

	 private static final Logger logger = Logger
				.getLogger(SmileDigitalInappPublisherService.class.getName());
