...
@Service("smashingLeadsInappPublisherService")
public class SmashingLeadsInappPublisherService implements IInappPublisherService{

	 private static final Logger logger = Logger
				.getLogger(SmashingLeadsInappPublisherService.class.getName());
