...
@Service("mplusInappPublisherService")
public class MplusInappPublisherService implements IInappPublisherService{

	 private static final Logger logger = Logger
				.getLogger(MplusInappPublisherService.class.getName());
