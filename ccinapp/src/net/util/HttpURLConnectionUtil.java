		...
		public HTTPResponse sendHttpsGet(String url,Map<String,String> headerMap) {
		 ...
		 public HTTPResponse makeHTTPPOSTRequest(String url,String json,Map<String,String> headerMap) {
			 ...
			 try {
				 ...
				 c.setRedirectStrategy(new LaxRedirectStrategy());
				 ...
				 HttpParams params = new BasicHttpParams();
		           ...
		           if(responseHeader!=null){  
			           for(Header header: responseHeader){
			        	   httpResponse.getResponseHeader().put(header.getName(),header.getValue());			            	 
			             }
		           }
		            BufferedReader rd = new BufferedReader(new InputStreamReader(r.getEntity().getContent()));
		            String line = "";
		        	...
		        	result=ex.toString();
		        	httpResponse.setResponseStr(ex.toString());
		        	logger.error("makeHTTPGETRequest:: ",ex);
		        }  
			 return httpResponse;
		    } 

		 
		 public HTTPResponse makeHTTPHeadRequest(String url,Map<String,String> data,Map<String,String> headerMap) {
			 String result ="";   
			 HTTPResponse httpResponse=new HTTPResponse(); 
			 try {
		            HttpClient c = new DefaultHttpClient();        
